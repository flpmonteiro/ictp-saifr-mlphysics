"""use a convolutional neural network to analyze the phase of the ising model
"""
import sys
import numpy as np
...
numberlabels = 2 # Number of phases under consideration (2 for the Ising modelon the square lattice)
hiddenunits1 = 100 # number of hidden units in the hidden layer
lamb = 0.001 # regularization parameter
beta = 1.0 # 'inverse temperature' of the sigmoid neuron

# Parameters of the optimization
bsize = 1500 # batch size for the gradient descent
